...
import de.tekup.library.dto.request.AuthRequest;
import de.tekup.library.dto.response.AuthResponse;
import de.tekup.library.entity.User;
import de.tekup.library.repository.UserRepository;
import de.tekup.library.util.JwtUtil;
...
public class JwtService implements UserDetailsService {
    ...
    private void authenticate(String userName, String userPassword) throws Exception {
        ...
        try {
            ...
            throw new de.tekup.library.exception.BadCredentialsException("Bad Credentials");
